...
# "Web Real-Time Communication Use-cases and Requirements":http://tools.ietf.org/html/draft-ietf-rtcweb-use-cases-and-requirements-06
...
| FireFox 7.0.1 [3]                   |=.      2291         |=.           3191       |
|                                     |                     |                        |
|_. Windows 7 in VirtualBox           |_\2>.                                         |
| Chrome 14.0.835.202                 |=.      5165         |=.          10661       |
| IE v9.0.8112.16421 [3]              |=.      3941         |=.           5682       |
| FireFox 7.0.1 [3]                   |=.      2484         |=.           3934       |
| Safari v5.1.1 (7534.51.22)          |=.       507         |=.            815       |
|                                     |                     |                        |
...
fn3. _There is a "Canvas-related bug in FireFox":https://bugzilla.mozilla.org/show_bug.cgi?id=695959 and "IE9":http://social.msdn.microsoft.com/Forums/en-US/iewebdevelopment/thread/9c1e01fb-2592-4f6f-a623-edcfb655e8e5">IE9 which prevents the display of data in the graph while the model is running._
