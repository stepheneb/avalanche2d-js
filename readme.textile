...
Testing  Oct 28 2011 show this JavaScript adaptation runs the model about the same speed as the native Scala version and about 12 times faster than "Bureaucrats-fast":logo/Bureaucrats-fast.nlogo">Bureaucrats-fast in NetLogo 5.0RC2. When displaying the folder visualization and graphing the JavaScript adaptation is 
