...
_All these tests were run on a MacBook Pro, 2.66 GHz Intel Core i7, Mac OS X 10.6.8 on October 21, 2011._

|_. Tablets and SmartPhones    |_\2>. ave rate (steps/s) for 5000 steps |
|_.                            |_.             |_. graph and canvas off |
