...
Seth Tisue, the lead NetLogo developer contributed "Bureaucrats-fast":http://stepheneb.github.com/avalanche2d-js/nlogo/Bureaucrats-fast.nlogo
a simplified re-write of "Bureaucrats.v6":http://stepheneb.github.com/avalanche2d-js/nlogo/Bureaucrats.v6.nlogo that runs about twice as fast. "Bureaucrats-fast":http://stepheneb.github.com/avalanche2d-js/nlogo/Bureaucrats-fast.nlogo is more appropriate to use when comparing performance with this JavaScript adaptation.

Testing on Oct 20 2011 show this JavaScript adaptation runs about 30x faster than "Bureaucrats-fast":http://stepheneb.github.com/avalanche2d-js/nlogo/Bureaucrats-fast.nlogo in NetLogo 5.0RC2 when displaying folders and graphing and about seven times faster running just the computational model (Chrome 14.0.835.186 on a Mac OS X 10.6.8 system with a 2.66 GHz Intel Core i7).
...
h3. Time for modeling and rendering to both the model canvas and the real-time graph rendering using a Canvas overlay over the D3.js SVG graph.

_MacBook Pro, 2.66 GHz Intel Core i7, Mac OS X 10.6.8_

|_. Mac OS X 10.6.8            |_\2>. ave rate (steps/s) for 5000 steps |
|_. Browser                    |_.             |_. graph and canvas off |
| Chrome 14.0.835.186          |     1719      |            12920       |
| Safari v5.1.1 (6534.51.22)   |      554      |             4022       |
| FireFox 7.0.1 [1]            |      229      |             2994       |
|                              |               |                        |
|_. Windows 7 in VirtualBox    |_\2>.                                   |
| Chrome 14.0.835.202          |      683      |            19231       |
| IE v9.0.8112.16421 [1]       |      440      |             4995       |
| FireFox 7.0.1 [1]            |      285      |             3477       |
| Safari v5.1.1 (7534.51.22)   |      248      |              678       |
|                              |               |                        |
|_. NetLogo 5.0RC2             |_\2>.                                   |
| Bureaucrats-fast             |       57      |             1786       |


|_. Tablets and SmartPhones    |_\2>.                                   |
| iPad2, iOS 4.3.1             |       60      |              268       |

_Data collected October 21, 2011_

fn1. There is a "Canvas-related bug in FireFox":https://bugzilla.mozilla.org/show_bug.cgi?id=695959 which prevents the display of data in the graph while the model is running. This issue is also present in IE9.
