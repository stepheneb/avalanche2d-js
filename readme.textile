...
Seth Tisue, the lead NetLogo developer contributed "Bureaucrats-fast":http://stepheneb.github.com/avalanche2d-js/nlogo/Bureaucrats-fast.nlogo a simplified re-write of "Bureaucrats.v6":http://stepheneb.github.com/avalanche2d-js/nlogo/Bureaucrats.v6.nlogo that runs about twice as fast. "Bureaucrats-fast":http://stepheneb.github.com/avalanche2d-js/nlogo/Bureaucrats-fast.nlogo is more appropriate to use when comparing performance of a NetLogo model with this JavaScript adaptation.

Testing on Oct 20 2011 show this JavaScript adaptation runs about 30x faster than "Bureaucrats-fast":http://stepheneb.github.com/avalanche2d-js/nlogo/Bureaucrats-fast.nlogo when displaying folders and graphing and about seven times faster running just the computational model. See **Benchmarks** section below.
