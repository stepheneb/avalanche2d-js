...
fn3. _There is a "Canvas-related bug in FireFox":https://bugzilla.mozilla.org/show_bug.cgi?id=695959 which prevents the display of data in the graph while the model is running. This issue is also present in IE9.__
