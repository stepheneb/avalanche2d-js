...
Testing on Oct 20 2011 show this JavaScript adaptation runs about four times faster on Chrome than "Bureaucrats-fast":http://stepheneb.github.com/avalanche2d-js/nlogo/Bureaucrats-fast.nlogo when displaying folders and graph and about 11 times faster running just the computational model. See **Benchmarks** section below.
