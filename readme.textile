...
A partial "JavaScript port":https://github.com/stepheneb/avalanche2d-js of Bob Tinker's "NetLogo":http://ccl.northwestern.edu/netlogo/ model "Bureaucrats.v6":https://github.com/stepheneb/avalanche2d-js/nlogo/Bureaucrats.v6.nlogo'>Bureaucrats.v6 exploring "Self-Organised Criticality":http://en.wikipedia.org/wiki/Self-organized_criticality
